...
$cfg['Servers'][$i]['password']      = 'liverpool';          // MySQL password (only needed
...
$cfg['Servers'][$i]['password']        = 'liverpool';
...
$cfg['SQLValidator']['username'] = 'liverpool';      // If you have a custom username, specify it here (defaults to anonymous)
