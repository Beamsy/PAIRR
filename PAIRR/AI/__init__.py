...
def remove_event_detects():
    GPIO_utils.GPIO.remove_event_detect(GPIO_utils.good_button_pin, callback=increase_relation(), bouncetime=300)
    GPIO_utils.GPIO.remove_event_detect(GPIO_utils.bad_button_pin, callback=increase_relation(), bouncetime=300)
